...
export async function POST(req: NextRequest) {
  ...
  // 2) Volet paiement (libération / remboursement / prélèvement tardif automatique)
  try { await traiterAnnulationPropay(rdvId) } catch (e) { console.error('[rdv/annuler] propay:', e) }
