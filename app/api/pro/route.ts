...
const CHAMPS_PUBLICS = 'id, prenom, nom, pseudo, slug, avatar_url, photo_url, message_accueil, adresse, instagram, tiktok, snapchat, horaires, horaires_specifiques, creneaux_bloques, planning_variable, fidelite_config, acompte_config, is_pro, devise, langue, timezone, categorie_autre_nom, categorie_autre_icone'
