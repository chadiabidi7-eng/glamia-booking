...
// Les prix ne sont PAS formatés ici : lib/devise.ts fait autorité, comme dans
// l'app mobile. Intl rendrait « F CFA 30 » là où la pro voit « 30 FCFA » dans
// son application — deux affichages différents du même tarif, sur sa page et
// dans son app.
